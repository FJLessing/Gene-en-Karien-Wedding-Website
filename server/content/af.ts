...
const af: SiteContent = {
	...
	ui: {
		...
		venue: {
			...
			activitiesSubTitle:  "Neem asseblief kennis dat alle aktiwiteite vooraf by die venue bespreek moet word.",
		...
		gate: {
			...
			hint: "Tik of klik op die koevert om te begin",
		},
		...
		rsvp: {
			...
			countryCodes: [
				{ label: "Suid-Afrika (+27)", value: "+27" },
				{ label: "Verenigde Koninkryk (+44)", value: "+44" },
				{ label: "Verenigde State (+1)", value: "+1" },
				{ label: "Australië (+61)", value: "+61" },
				{ label: "Nieu-Seeland (+64)", value: "+64" },
				{ label: "Duitsland (+49)", value: "+49" },
				{ label: "Nederland (+31)", value: "+31" },
				{ label: "VAE (+971)", value: "+971" },
				{ label: "Frankryk (+33)", value: "+33" },
